 ...
 */
public class ShootBeamBreakCommand extends Command{
    Timer t = new Timer();
    ...
    /**
     * Constructs an ShootBeamBreakCommand.
     ...
     */
    public ShootBeamBreakCommand(IntakeShooter intakeShooterSubsystem, BeamBreak beamBreakSensor){
